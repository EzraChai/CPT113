...
class named CustomerData, which is derived from the PersonData class. The CustomerData
...
The mailingList variable should be a bool . It will be set to true if the customer wishes to be on a
